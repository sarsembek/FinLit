    ...
    >
      <div className="relative flex flex-col items-center w-full pt-8">
        ...
        <button
          ...
          className="absolute left-4 top-20 md:top-9 md:left-8 text-white bg-transparent border border-white rounded-full p-2 hover:bg-white hover:bg-opacity-20 transition-all z-10"
